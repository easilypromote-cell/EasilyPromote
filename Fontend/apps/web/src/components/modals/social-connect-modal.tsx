    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-stone-950/40 backdrop-blur-sm">
      <div className="bg-white border border-stone-200 rounded-3xl p-8 max-w-sm w-full shadow-xl space-y-6 mx-4 animate-in fade-in zoom-in duration-150">
        <div className="space-y-1.5">
          <h3 className="font-rethink font-bold text-lg text-stone-900">Connect a social account</h3>
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-xs font-semibold text-stone-500 mb-1.5">Platform</label>
          ...
          <div>
            <label className="block text-xs font-semibold text-stone-500 mb-1.5">Social Handle</label>
            <input
              type="text"
              placeholder="@yourhandle"
              value={handle}
              onChange={(e) => onHandleChange(e.target.value)}
              className="w-full px-4 py-2.5 bg-stone-50 border border-stone-200 rounded-full text-xs font-medium text-stone-950 placeholder-stone-400 focus:outline-none focus:border-stone-300"
            />
          </div>
        </div>

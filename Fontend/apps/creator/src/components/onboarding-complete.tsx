...
export function OnboardingComplete({ profile, onBrowseCampaigns }: OnboardingCompleteProps) {
  ...
  return (
    <div className="w-full flex flex-col items-center max-w-xl text-center">
      <div className="mb-6 border border-stone-200 bg-white rounded-3xl p-6 max-w-xs mx-auto -rotate-1">
      ...
      <p data-reveal className="text-sm text-stone-500 mb-8 font-medium">
      ...
      <button
        ...
        className="w-full max-w-[300px] py-4 bg-[#FEB604] text-stone-900 font-semibold text-sm rounded-full font-rethink border border-stone-100"
      >
        Browse campaigns
      </button>
    </div>

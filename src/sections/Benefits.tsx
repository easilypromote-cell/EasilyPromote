...
export default function Benefits() {
  ...
  return (
    <section ref={sectionRef} className="py-16 tablet:py-20 desktop:py-24 bg-darkSurface text-white relative overflow-hidden">

      <Container className="relative z-10">
        <div className="flex flex-col tablet:flex-row items-end justify-between gap-24">
          <div className="max-w-[500px]">
            <h2 ref={headingRef} className="text-[36px] leading-[110%] tracking-[-0.05em] font-semibold">
              Get creators promoting<br />your brand at scale, without<br />wasting ad spend.
            </h2>
            <p ref={subtextRef} className="text-[15px] leading-[180%] text-gray-300 mt-4 max-w-[450px]">

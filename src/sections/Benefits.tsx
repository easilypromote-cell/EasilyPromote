        ...
        <div className="flex flex-col tablet:flex-row items-center justify-between gap-24">
          <div className="max-w-[500px]">
            <h2 className="text-[36px] leading-[110%] tracking-[-0.05em] font-semibold">
              Get creators promoting<br />your brand at scale,<br />without wasting ad spend.
            </h2>
            <p className="text-[15px] leading-[180%] text-gray-300 mt-4">
              Launch campaigns that multiple creators can join at once. Set a target view count, fund your campaign, and only pay when content performs.
            </p>
          </div>
